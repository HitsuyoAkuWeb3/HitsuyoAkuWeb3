...
| --- | --- |
| [Architect](https://architect.hitsuyoaku.io) | The primary diagnostic route for Identity Forensics Lab. |
...
3. Keep private memory, AI workbenches, and GitHub records in their proper lanes.
4. Leave a system that can be reviewed, reused, and handed off.

## Deeper Reading

[Read the operating doctrine](docs/operating-doctrine.md) for the three-layer model and the audit, build, and governance practice.

## Public Record

- [Identity Forensics Lab](https://architect.hitsuyoaku.io)
- [GitMoneyOS](https://github.com/GitMoneyOS)
- [GitMoneyOS Public Framework](https://github.com/GitMoneyOS/gitmoney-public-framework)
